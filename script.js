...
//   }
// let threeIronFacts = `
// <h1>Summary:${movieIronMan["description"]}</h1>
// <h1>Gross:${movieIronMan["gross"]}</h1>
// <h1>Release Date: ${movieIronMan["releaseDate"]} </h1>
// `
// $("#display-area").append(threeIronFacts)
//
...
<h1>${movieListDetailed[i]["rottenTomatoes"]}</h1>
<h1>${movieListDetailed[i]["releaseDate"]}</h1>
</div>
  `
